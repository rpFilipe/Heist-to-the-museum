 ...
 */
public class AssaultPartyProxy implements IotAssaultParty, ImtAssaultParty{
    
    String SERVER_ADDR;
    int SERVER_PORT;

    /**
     * Create a Proxy to Communicate with the Assault Party Server
     * @param i Id of the Assault Party
     * @param configServerAddr Configuration Server address.
     * @param configServerPort Configuration Server port.
     */
    public AssaultPartyProxy(int i, String configServerAddr, int configServerPort) {
